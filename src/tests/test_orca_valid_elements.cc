...
CASE( "test generate fesom mesh" ) {
    std::vector<std::string> gridnames{
        "FESOM2_T", "FESOM2_F", "FESOM2_U", "FESOM2_V", "eFESOM1_T", "eFESOM1_F", "eFESOM1_U", "eFESOM1_V",
        //"FESOM1_T", "FESOM1_F", "FESOM1_U", "FESOM1_V",
        //"eFESOM025_T", "eFESOM025_F", "eFESOM025_U", "eFESOM025_V",
    };
